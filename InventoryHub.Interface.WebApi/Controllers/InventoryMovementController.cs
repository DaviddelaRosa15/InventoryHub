...
namespace InventoryHub.Interface.WebApi.Controllers
{
    ...
    public class InventoryMovementController : Controller
    {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(RegisterMovementDTO))]
        ...
        [HttpPost("exit")]
        [SwaggerOperation(
           Summary = "Registrar movimiento de salida",
           Description = "Nos permite usar del inventario un producto"
        )]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(RegisterMovementDTO))]
        [ProducesResponseType(StatusCodes.Status400BadRequest, Type = typeof(ErrorDTO))]
        [ProducesResponseType(StatusCodes.Status401Unauthorized, Type = typeof(ErrorDTO))]
